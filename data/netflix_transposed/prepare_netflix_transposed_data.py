...
train_data_file = "netflix_train.txt"
#test_data_file = maybe_download('netflix_mme', 21053723)
test_data_file = "netflix_test.txt"
...
test_i,test_j,test_rating = np.loadtxt(test_data_file,dtype=np.int32, unpack=True)
R_test_coo = coo_matrix((test_rating,(test_i,test_j)))
...
train_i,train_j,train_rating = np.loadtxt(train_data_file,dtype=np.int32, unpack=True)
R_train_coo = coo_matrix((train_rating,(train_i,train_j)))
